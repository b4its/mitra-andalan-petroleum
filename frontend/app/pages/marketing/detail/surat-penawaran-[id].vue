    ...
    .createPdf({
      ...
      content: [
        ...
        },
        {
          text: "Hormat Kami,",
          marginTop: 15,
          marginBottom: signature.value?.url ? 5 : 30,
        },
        ...(signature.value?.url
          ? [
              {
          ...
          : []),
        {
          ...
          bold: true,
          marginTop: signature.value?.url ? 5 : 30,
        },
        {
          layout: {
            defaultBorder: false,
      ...
      images: signature.value?.url
        ? {
            userSignature: `http://localhost:8000${signature.value.url}`,
          }
        : {},
    })
    .getDataUrl();
