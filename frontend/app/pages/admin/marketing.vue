...
const columns: TableColumn<ApiOfferingLetter>[] = [
  ...
  { accessorKey: "customer_name", header: "Customer" },
  {
    ...
    cell: ({ row }) => formatCurrency(row.getValue("fuel_total_price") ?? 0),
  },
  {
    accessorKey: "transport_price",
    header: "Ongkos Transportir",
    cell: ({ row }) => formatCurrency(row.getValue("transport_price") ?? 0),
  },
  {
    accessorKey: "status",
    header: "Status",
        ...
        <template v-else>
          ...
          <div>
            <div class="mb-3 flex items-center justify-between">
              ...
              <p class="text-xs text-muted">Visualisasi data marketing</p>
            </div>
            <div class="grid gap-6 lg:grid-cols-2">
              <UCard>
                <template #header>
              ...
              <UCard>
                <template #header>
                  <div class="flex items-center justify-between">
                    <p class="font-medium">Distribusi Status Surat Penawaran</p>
