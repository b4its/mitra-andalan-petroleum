            ...
            table: {
              ...
              body: [
                ...
                [
                  ...
                  infoValueCell(
                    `${details.customerPurchaseInformation.customerPurchaseOrderNumber.purchaseOrderNumber}`,
                  ),
                ],
                [
                ...
                [
                  ...
                  infoHeaderCell(
                    formatDate(details.invoiceInformation.invoiceDueDate),
                  ),
                  infoHeaderCell(
                    `${details.customerPurchaseInformation.taxInvoiceNumber}`,
                  ),
                  infoHeaderCell(
                    `${details.customerPurchaseInformation.salesOrderNumber || ""}`,
                  ),
                ],
              ],
            },
            ...
            table: {
              ...
              body: [
                ...
                [
                  ...
                  {
                    text: [
                      "Invoice will be considered ",
                      { text: "PAID", bold: true },
                      " once seller has received full amount on the stated account",
                    ],
                    colSpan: 3,
                  },
                  {},
