...
export interface ApiStats {
  stats: { title: string; icon: string; value: number | string; variation: number; to: string }[]
}

export function mapOfferingLetter(ol: ApiOfferingLetter): MarketingOfferingLetterOverview {
  return {
    id: ol.id,
...
export function mapDeliveryOrder(do_: ApiDeliveryOrder): OperationsDeliveryOrderOverview {
  return {
    id: do_.id,
...
export function mapInvoice(inv: ApiInvoice): FinanceInvoiceOverview {
  return {
    ...
    invoiceStatus: inv.invoice_status as FinanceInvoiceOverview['invoiceStatus'],
    deadlineStatus: inv.deadline_status as FinanceInvoiceOverview['deadlineStatus'],
  }
}
