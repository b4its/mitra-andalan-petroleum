...
export function usePoTransportPdf() {
  ...
  async function buildPoTransportPdf(
    d: PoTransportirDetails,
  ): Promise<string | null> {
    ...
    const ppn =
      d.priceSummary?.ppn ??
      Math.round(subTotal * (d.percentageNum?.ppn || 0.11));
      ...
      (_, i) => [
        {
          ...
          border: [
            ...
            false,
            true,
            companyContacts.length > 1 && i === companyContacts.length - 1,
        ...
        },
        {
          ...
          border: [
            ...
            false,
            true,
            customerContacts.length > 1 && i === customerContacts.length - 1,
          ] as [boolean, boolean, boolean, boolean],
        },
      ],
    );
