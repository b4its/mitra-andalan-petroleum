...
<template>
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
    <UCard>
      <template #header>
        <p class="text-xs text-muted uppercase">Status Surat Penawaran</p>
      </template>
      <VisSingleContainer :data="olDistribution" :height="240" :margin="{ top: 20, bottom: 20, left: 20, right: 20 }">
        <VisDonut :value="valueAccessor" :color="colorAccessor" :central-label="totalSum(olDistribution)" central-sub-label="Total" :arc-width="32" />
    ...
    <UCard>
      <template #header>
        <p class="text-xs text-muted uppercase">Tipe Purchase Order</p>
      </template>
      <VisSingleContainer :data="poDistribution" :height="240" :margin="{ top: 20, bottom: 20, left: 20, right: 20 }">
        <VisDonut :value="valueAccessor" :color="colorAccessor" :central-label="totalSum(poDistribution)" central-sub-label="Total" :arc-width="32" />
        <VisTooltip :template="tooltipTemplate" />
      </VisSingleContainer>
    </UCard>
    ...
    <UCard>
      <template #header>
        <p class="text-xs text-muted uppercase">Status Delivery Order</p>
      </template>
      <VisSingleContainer :data="doDistribution" :height="240" :margin="{ top: 20, bottom: 20, left: 20, right: 20 }">
        <VisDonut :value="valueAccessor" :color="colorAccessor" :central-label="totalSum(doDistribution)" central-sub-label="Total" :arc-width="32" />
        <VisTooltip :template="tooltipTemplate" />
      </VisSingleContainer>
    </UCard>
    ...
    <UCard>
      <template #header>
        <p class="text-xs text-muted uppercase">Status Invoice</p>
      </template>
      <VisSingleContainer :data="invoiceDistribution" :height="240" :margin="{ top: 20, bottom: 20, left: 20, right: 20 }">
        <VisDonut :value="valueAccessor" :color="colorAccessor" :central-label="totalSum(invoiceDistribution)" central-sub-label="Total" :arc-width="32" />
        <VisTooltip :template="tooltipTemplate" />
      </VisSingleContainer>
    </UCard>
  </div>
